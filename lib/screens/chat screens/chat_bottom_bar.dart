    ...
    return Align(
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(
            () => MyContainer(
              height: ctrl.isRecording.value == true ? 150 : 80,
              width: Get.width,
              color: ctrl.isRecording.value == true ? kDarkColor : kbgColor,
              child: Column(
                      ...
                      ? Row(
                        ...
                        children: [
                          ...
                          ctrl.isTimerOn.value == true
                              ? MyMusicalBeats()
                              : VoiceMessageView(
                                audioUrl: ctrl.recordedFilePath.toString(),
                                backgroundColor: kbgColor,
                                progressBarBackgroundColor: kDarkColor,
                                size: 50,
                              ),
                        ],
                      )
